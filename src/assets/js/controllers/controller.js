...
export class Controller {
    ...
    constructor() {
        ...
        this.#alertViewHtml = document.querySelector("alert");
    }
    ...
    async loadHtmlIntoAlert(htmlFile) {
        return await this.#fetchHtmlView(htmlFile, false, true)
    }
     ...
     * @private
     */
    async #fetchHtmlView(htmlFile, loadIntoNavigation = false, loadIntoAlert = false, customElement ) {
        let loadInto = loadIntoAlert ? this.#alertViewHtml : (loadIntoNavigation ? this.#navigationViewHtml : this.#contentViewHtml);
